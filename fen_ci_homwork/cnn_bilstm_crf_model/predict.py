...
data.make_test_normal('./data/testset.txt','./data/testset_normal.txt')#将测试集转化为标准数据集文件
X_test_cut,X_test_len,X_test_word,X_test_fenge=data.get_X('./data/testset_normal.txt')#转化test为标准格式
...
data.write_result_to_file('./data/2017140437.txt',Y_pred,X_test_len,X_test_word,X_test_fenge)
